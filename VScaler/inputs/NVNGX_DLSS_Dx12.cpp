...
NVSDK_NGX_API NVSDK_NGX_Result NVSDK_NGX_D3D12_GetParameters(NVSDK_NGX_Parameter** OutParameters)
{
        ...
        NVNGXProxy::D3D12_GetParameters() != nullptr)
    {
        ...
        // Copy VScaler config to real NGX param table
        if (result == NVSDK_NGX_Result_Success)
        {
                                             ...
                                             NVSDK_NGX_Parameter* InParameters, NVSDK_NGX_Handle** OutHandle)
{
    ...
    LOG_INFO("Creating VScaler feature, HandleId: {}", handleId);
                                                             ...
                                                             NVSDK_NGX_Handle** OutHandle)
{
    ...
    // VScaler internal handling (SuperSampling or RayReconstruction)
...
NVSDK_NGX_API NVSDK_NGX_Result NVSDK_NGX_D3D12_ReleaseFeature(NVSDK_NGX_Handle* InHandle)
{
    ...
    // VScaler handles start after this offset. If it's outside this range, it doesn't belong to VScaler.
    ...
    // Clean up VScaler feature with framegen
                                               ...
                                               PFN_NVSDK_NGX_ProgressCallback InCallback)
{
    ...
    if (InCallback)
        LOG_INFO("Progress callback provided but unused in synchronous VScaler path");
