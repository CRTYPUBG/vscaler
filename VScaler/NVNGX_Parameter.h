...
constexpr std::string_view AllocKey = "VScaler.ParamAllocType";
...
// VScaler implementation used internally with new/delete.
constexpr uint32_t InternDynamic = 3;
// VScaler implementation for legacy applications. Must maintain a persistent instance
 ...
 * VScaler tables use delete. Persistent tables are not freed.
 */
