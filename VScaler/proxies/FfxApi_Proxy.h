...
// SDK only has FFX_API_EFFECT_ID_FRAMEGENERATIONSWAPCHAIN (no DX12 suffix).
// Alias so existing code compiles unchanged.
...
// FFX_API_EFFECT_ID_FGSC_VK is defined in vk/ffx_api_vk.h (= FFX_API_EFFECT_ID_FRAMEGENERATIONSWAPCHAIN_VK)
#ifndef FFX_API_EFFECT_ID_FGSC_VK
#define FFX_API_EFFECT_ID_FGSC_VK FFX_API_EFFECT_ID_FRAMEGENERATIONSWAPCHAIN_VK
#endif
