...
std::optional<LatestReleaseInfo> FetchLatestRelease()
{
    ...
    session = WinHttpOpen(L"VScaler Version Check/1.0", WINHTTP_ACCESS_TYPE_DEFAULT_PROXY, WINHTTP_NO_PROXY_NAME,
    ...
    request = WinHttpOpenRequest(connection, L"GET", L"/repos/CRTYPUBG/vscaler/releases/latest", nullptr,
    ...
    LPCWSTR headers = L"User-Agent: VScaler\r\nAccept: application/vnd.github+json\r\nAccept-Encoding: identity\r\n";
...
void RunVersionCheck()
{
    ...
    if (updateAvailable)
    {
        LOG_WARN("New VScaler release available: {} (current {}.{}.{}).", release->tag, VER_MAJOR_VERSION,
