---
name: Crash/Bug
about: This template is for reporting issues when using VScaler
title: ''
labels: ''
assignees: ''
...
*Example:* VScaler_v0.7.7-pre7_20250316 + Fakenvapi 1.2.1 + Nukem 0.122 - VScaler version most important
...
#### Did you check the [Wiki](https://github.com/CRTYPUBG/vscaler/wiki) and [Compatibility List](https://github.com/CRTYPUBG/vscaler/wiki/Compatibility-List)?
 - [ ] Yes
 - [ ] No
...
#### I have attached
 - [ ] VScaler.log _(set `LogLevel=0` and `LogToFile=true` in VScaler.ini, zip it if too big)_
